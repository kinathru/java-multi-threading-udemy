package edu.kinath.udemy.imageprocessing;
...
//        reColorMultiThreaded( originalImage, resultImage, 4 );
    ...
    public static void reColorMultiThreaded( final BufferedImage originalImage, final BufferedImage resultImage, int numberOfThreads )
    {
